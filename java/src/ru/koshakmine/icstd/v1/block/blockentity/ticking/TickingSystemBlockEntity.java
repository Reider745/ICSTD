package ru.koshakmine.icstd.v1.block.blockentity.ticking;

import com.zhekasmirnov.apparatus.util.Java8BackComp;
import com.zhekasmirnov.innercore.api.NativeAPI;
import ru.koshakmine.icstd.v1.item.component.ICSTD;
import ru.koshakmine.icstd.v1.block.blockentity.BlockEntityBase;
...
import ru.koshakmine.icstd.v1.utils.type.common.ChunkPos;
...
public class TickingSystemBlockEntity {
    ...
    public ConcurrentLinkedDeque<BlockEntityBase> getTiles(Level level, int x, int z){
        final ConcurrentHashMap<ChunkPos, ConcurrentLinkedDeque<BlockEntityBase>> chunks = getChunks(level.getDimensionId(), dimensions);
